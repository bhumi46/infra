...
# Use specific AZs if provided, otherwise use all available AZs — same
# convention and same "pin AZs at your own InsufficientInstanceCapacity risk"
# gotcha as the pre-#273 monolith.
locals {
...
# Security group IDs — discovered by tag from #274 (security), not a
# module-source reference or shared state. #274 must have been applied first.
